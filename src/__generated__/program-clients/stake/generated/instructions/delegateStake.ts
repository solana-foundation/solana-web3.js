...
export function getDelegateStakeInstructionDataEncoder(): FixedSizeEncoder<DelegateStakeInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', getU32Encoder()]]), value => ({
        ...value,
        discriminator: DELEGATE_STAKE_DISCRIMINATOR,
    }));
}
...
export function parseDelegateStakeInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
