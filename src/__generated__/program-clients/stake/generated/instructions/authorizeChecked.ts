...
export type AuthorizeCheckedInstructionData = { discriminator: number; stakeAuthorize: StakeAuthorize };

export type AuthorizeCheckedInstructionDataArgs = { stakeAuthorize: StakeAuthorizeArgs };
...
export function parseAuthorizeCheckedInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
