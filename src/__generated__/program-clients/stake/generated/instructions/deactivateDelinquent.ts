...
>(
    ...
    return {
        ...
        accounts: { stake: getNextAccount(), delinquentVote: getNextAccount(), referenceVote: getNextAccount() },
        data: getDeactivateDelinquentInstructionDataDecoder().decode(instruction.data),
    };
}
