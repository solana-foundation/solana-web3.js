...
export function getSetLockupInstructionDataCodec(): Codec<SetLockupInstructionDataArgs, SetLockupInstructionData> {
...
export function parseSetLockupInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
