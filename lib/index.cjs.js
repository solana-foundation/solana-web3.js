...
async function sha256(data) {
  ...
  const digest = await globalThis.crypto.subtle.digest('SHA-256', codecsCore.toArrayBuffer(normalizedData));
...
const ADDRESS_CODEC = addresses.getAddressCodec();
...
class Address {
  ...
  async verifySignature(signature, message) {
    ...
    return keys.verifySignature(publicKeyCryptoKey, keys.signatureBytes(signature), message);
  }
  ...
  static async createWithSeed(fromAddress, seed, programId) {
    ...
    addresses.assertIsAddress(baseAddress);
    const programAddress = programId.toBase58();
    addresses.assertIsAddress(programAddress);
    const derivedAddress = await addresses.createAddressWithSeed({
      baseAddress,
      programAddress,
      seed
    });
...
function bytesFromAddressString(value) {
  addresses.assertIsAddress(value);
...
const BASE58_ENCODER$2 = codecsStrings.getBase58Encoder();
const BASE58_DECODER$1 = codecsStrings.getBase58Decoder();
const PUBLIC_KEY_DECODER$1 = codecsCore.fixDecoderSize(codecsDataStructures.getBytesDecoder(), PUBLIC_KEY_LENGTH);
const COMPILED_INSTRUCTION_DECODER$1 = codecsDataStructures.getStructDecoder([['programIdIndex', U8_DECODER$3], ['accounts', codecsDataStructures.getArrayDecoder(U8_DECODER$3, {
  size: SHORT_U16_DECODER$3
})], ['data', codecsDataStructures.getArrayDecoder(U8_DECODER$3, {
  size: SHORT_U16_DECODER$3
})]]);
const MESSAGE_DECODER = codecsDataStructures.getStructDecoder([['numRequiredSignatures', U8_DECODER$3], ['numReadonlySignedAccounts', U8_DECODER$3], ['numReadonlyUnsignedAccounts', U8_DECODER$3], ['accountKeys', codecsDataStructures.getArrayDecoder(PUBLIC_KEY_DECODER$1, {
  size: SHORT_U16_DECODER$3
})], ['recentBlockhash', PUBLIC_KEY_DECODER$1], ['instructions', codecsDataStructures.getArrayDecoder(COMPILED_INSTRUCTION_DECODER$1, {
  size: SHORT_U16_DECODER$3
})]]);
...
class Message {
  ...
  serialize() {
    ...
    instructions.forEach(instruction => {
      const instructionLayout = codecsDataStructures.getStructEncoder([['programIdIndex', U8_ENCODER$1], ['keyIndicesCount', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), instruction.keyIndicesCount.length)], ['keyIndices', codecsDataStructures.getArrayEncoder(U8_ENCODER$1, {
        size: instruction.keyIndices.length
      })], ['dataLength', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), instruction.dataLength.length)], ['data', codecsDataStructures.getArrayEncoder(U8_ENCODER$1, {
    ...
    const signDataLayout = codecsDataStructures.getStructEncoder([['numRequiredSignatures', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), 1)], ['numReadonlySignedAccounts', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), 1)], ['numReadonlyUnsignedAccounts', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), 1)], ['keyCount', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), keyCount.length)], ['keys', codecsDataStructures.getArrayEncoder(codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), PUBLIC_KEY_LENGTH), {
      size: numKeys
    })], ['recentBlockhash', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), PUBLIC_KEY_LENGTH)]]);
    const transaction = {
...
const BYTES_ENCODER = codecsDataStructures.getBytesEncoder();
...
const BASE58_ENCODER$1 = codecsStrings.getBase58Encoder();
const BASE58_DECODER = codecsStrings.getBase58Decoder();
const PUBLIC_KEY_DECODER = codecsCore.fixDecoderSize(codecsDataStructures.getBytesDecoder(), PUBLIC_KEY_LENGTH);
const COMPILED_INSTRUCTION_DECODER = codecsDataStructures.getStructDecoder([['programIdIndex', U8_DECODER$2], ['accountKeyIndexes', codecsDataStructures.getArrayDecoder(U8_DECODER$2, {
  size: SHORT_U16_DECODER$2
})], ['data', codecsDataStructures.getArrayDecoder(U8_DECODER$2, {
  size: SHORT_U16_DECODER$2
})]]);
const ADDRESS_TABLE_LOOKUP_DECODER = codecsDataStructures.getStructDecoder([['accountKey', PUBLIC_KEY_DECODER], ['writableIndexes', codecsDataStructures.getArrayDecoder(U8_DECODER$2, {
  size: SHORT_U16_DECODER$2
})], ['readonlyIndexes', codecsDataStructures.getArrayDecoder(U8_DECODER$2, {
  size: SHORT_U16_DECODER$2
})]]);
const MESSAGE_V0_DECODER = codecsDataStructures.getStructDecoder([['prefix', U8_DECODER$2], ['header', codecsDataStructures.getStructDecoder([['numRequiredSignatures', U8_DECODER$2], ['numReadonlySignedAccounts', U8_DECODER$2], ['numReadonlyUnsignedAccounts', U8_DECODER$2]])], ['staticAccountKeys', codecsDataStructures.getArrayDecoder(PUBLIC_KEY_DECODER, {
  size: SHORT_U16_DECODER$2
})], ['recentBlockhash', PUBLIC_KEY_DECODER], ['compiledInstructions', codecsDataStructures.getArrayDecoder(COMPILED_INSTRUCTION_DECODER, {
  size: SHORT_U16_DECODER$2
})], ['addressTableLookups', codecsDataStructures.getArrayDecoder(ADDRESS_TABLE_LOOKUP_DECODER, {
  size: SHORT_U16_DECODER$2
})]]);
...
class MessageV0 {
  ...
  serialize() {
    ...
    const messageLayout = codecsDataStructures.getStructEncoder([['prefix', U8_ENCODER], ['header', codecsDataStructures.getStructEncoder([['numRequiredSignatures', U8_ENCODER], ['numReadonlySignedAccounts', U8_ENCODER], ['numReadonlyUnsignedAccounts', U8_ENCODER]])], ['staticAccountKeysLength', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), encodedStaticAccountKeysLength.length)], ['staticAccountKeys', codecsDataStructures.getArrayEncoder(codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), PUBLIC_KEY_LENGTH), {
      size: this.staticAccountKeys.length
    })], ['recentBlockhash', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), PUBLIC_KEY_LENGTH)], ['instructionsLength', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), encodedInstructionsLength.length)], ['serializedInstructions', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), serializedInstructions.length)], ['addressTableLookupsLength', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), encodedAddressTableLookupsLength.length)], ['serializedAddressTableLookups', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), serializedAddressTableLookups.length)]]);
  ...
  serializeInstructions() {
    ...
    for (const instruction of this.compiledInstructions) {
      ...
      const instructionLayout = codecsDataStructures.getStructEncoder([['programIdIndex', U8_ENCODER], ['encodedAccountKeyIndexesLength', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), encodedAccountKeyIndexesLength.length)], ['accountKeyIndexes', codecsDataStructures.getArrayEncoder(U8_ENCODER, {
        size: instruction.accountKeyIndexes.length
      })], ['encodedDataLength', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), encodedDataLength.length)], ['data', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), instruction.data.length)]]);
...
const BASE58_CODEC = codecsStrings.getBase58Codec();
const SHORT_U16_ENCODER = codecsNumbers.getShortU16Encoder();
const SHORT_U16_DECODER$1 = codecsNumbers.getShortU16Decoder();
const SIGNATURE_DECODER$1 = codecsCore.fixDecoderSize(codecsDataStructures.getBytesDecoder(), SIGNATURE_LENGTH_IN_BYTES);
const TRANSACTION_WIRE_DECODER = codecsDataStructures.getStructDecoder([['signatures', codecsDataStructures.getArrayDecoder(SIGNATURE_DECODER$1, {
...
const SIGNATURE_ENCODER = codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), SIGNATURE_LENGTH_IN_BYTES);
const SIGNATURE_DECODER = codecsCore.fixDecoderSize(codecsDataStructures.getBytesDecoder(), SIGNATURE_LENGTH_IN_BYTES);
const VERSIONED_TRANSACTION_ENCODER = codecsDataStructures.getStructEncoder([['signatures', codecsDataStructures.getArrayEncoder(SIGNATURE_ENCODER, {
  size: codecsNumbers.getShortU16Encoder()
})], ['serializedMessage', codecsDataStructures.getBytesEncoder()]]);
const VERSIONED_TRANSACTION_DECODER = codecsDataStructures.getStructDecoder([['signatures', codecsDataStructures.getArrayDecoder(SIGNATURE_DECODER, {
  size: codecsNumbers.getShortU16Decoder()
})], ['serializedMessage', codecsDataStructures.getBytesDecoder()]]);
/**
...
const BYTES_DECODER = codecsDataStructures.getBytesDecoder();
 ...
 * @internal
 */
const NONCE_ACCOUNT_DECODER = codecsDataStructures.getStructDecoder([['version', U32_DECODER$1], ['state', U32_DECODER$1], ['authorizedPubkey', codecsCore.fixDecoderSize(BYTES_DECODER, 32)], ['nonce', codecsCore.fixDecoderSize(BYTES_DECODER, 32)], ['lamportsPerSignature', U64_DECODER$1]]);
...
const I64_NUMBER_CODEC$2 = codecsCore.transformCodec(codecsNumbers.getI64Codec(), value => BigInt(value), value => Number(value));
const PUBLIC_KEY_BYTES_CODEC$3 = codecsCore.fixCodecSize(codecsDataStructures.getBytesCodec(), 32);
const getRustStringCodec$2 = () => codecsCore.addCodecSizePrefix(codecsStrings.getUtf8Codec(), U64_CODEC$5);
...
const INSTRUCTION_DEFS$3 = {
  Create: {
    index: 0,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['lamports', I64_NUMBER_CODEC$2], ['space', I64_NUMBER_CODEC$2], ['programId', PUBLIC_KEY_BYTES_CODEC$3]])
  },
  Assign: {
    index: 1,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['programId', PUBLIC_KEY_BYTES_CODEC$3]])
  },
  Transfer: {
    index: 2,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['lamports', U64_CODEC$5]])
  },
  CreateWithSeed: {
    index: 3,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['base', PUBLIC_KEY_BYTES_CODEC$3], ['seed', RUST_STRING_CODEC$2], ['lamports', I64_NUMBER_CODEC$2], ['space', I64_NUMBER_CODEC$2], ['programId', PUBLIC_KEY_BYTES_CODEC$3]])
  },
  AdvanceNonceAccount: {
    index: 4,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6]])
  },
  WithdrawNonceAccount: {
    index: 5,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['lamports', I64_NUMBER_CODEC$2]])
  },
  InitializeNonceAccount: {
    index: 6,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['authorized', PUBLIC_KEY_BYTES_CODEC$3]])
  },
  ...
  Allocate: {
    index: 8,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['space', I64_NUMBER_CODEC$2]])
  },
  AllocateWithSeed: {
    index: 9,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['base', PUBLIC_KEY_BYTES_CODEC$3], ['seed', RUST_STRING_CODEC$2], ['space', I64_NUMBER_CODEC$2], ['programId', PUBLIC_KEY_BYTES_CODEC$3]])
  },
  AssignWithSeed: {
    index: 10,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['base', PUBLIC_KEY_BYTES_CODEC$3], ['seed', RUST_STRING_CODEC$2], ['programId', PUBLIC_KEY_BYTES_CODEC$3]])
  },
  TransferWithSeed: {
    index: 11,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6], ['lamports', U64_CODEC$5], ['seed', RUST_STRING_CODEC$2], ['programId', PUBLIC_KEY_BYTES_CODEC$3]])
  },
  UpgradeNonceAccount: {
    index: 12,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$6]])
...
const LOAD_INSTRUCTION_HEADER_CODEC = codecsDataStructures.getStructCodec([['instruction', U32_CODEC$5], ['offset', U32_CODEC$5], ['bytesLength', U32_CODEC$5], ['bytesLengthPadding', U32_CODEC$5]]);
const FINALIZE_INSTRUCTION_CODEC = codecsDataStructures.getStructCodec([['instruction', U32_CODEC$5]]);
...
const PUBLIC_KEY_CODEC$2 = codecsCore.transformCodec(codecsCore.fixCodecSize(codecsDataStructures.getBytesCodec(), 32), value => value, value => new Uint8Array(value));
...
const BASE58_ENCODER = codecsStrings.getBase58Encoder();
const BASE64_CODEC = codecsStrings.getBase64Codec();
...
function createKitRpcClient(url, config) {
  ...
  return {
    rpc: rpc.createRpc({
      api: rpc.createJsonRpcApi(),
      transport
    }),
    typedRpc: rpc.createRpc({
      api: rpcApi.createSolanaRpcApi({
...
class Connection {
   ...
   * ```
   */
  async requestAirdrop(to, lamports, commitmentOrConfig) {
    const {
      commitment
    } = extractCommitmentFromConfig(commitmentOrConfig);
    const rpcCommitment = commitment ?? this._commitment;
    try {
      return await (rpcCommitment == null ? this._typedRpc.requestAirdrop(toKitAddress(to), rpcTypes.lamports(coerceNumericToBigInt(lamports, 'lamports'))) : this._typedRpc.requestAirdrop(toKitAddress(to), rpcTypes.lamports(coerceNumericToBigInt(lamports, 'lamports')), {
        commitment: rpcCommitment
      })).send();
    } catch (error) {
...
class Keypair {
  ...
  static async fromSecretKey(secretKey) {
    ...
    const keypair = await keys.createKeyPairFromBytes(packedSecretKey);
  ...
  static async fromSeed(seed) {
    ...
    const keypair = await keys.createKeyPairFromPrivateKeyBytes(packedSeed);
    const publicKeyBytes = await exportCryptoKeyBytes(keypair.publicKey);
  ...
  async signBytes(message) {
    ...
    return keys.signBytes(privateKey, signMessage);
  }
  ...
  async verifySignature(signature, message) {
    ...
    const verifySignatureBytes = keys.signatureBytes(toPackedUint8Array(signature));
    const verifyMessage = toPackedUint8Array(message);
    return keys.verifySignature(publicKey, verifySignatureBytes, verifyMessage);
  }
}
...
const PUBLIC_KEY_BYTES_CODEC$2 = codecsCore.fixCodecSize(codecsDataStructures.getBytesCodec(), 32);
const PUBLIC_KEY_CODEC$1 = codecsCore.transformCodec(PUBLIC_KEY_BYTES_CODEC$2, value => value.toBytes(), bytes => new Address(bytes));
const PUBLIC_KEY_ARRAY_CODEC = codecsDataStructures.getArrayCodec(PUBLIC_KEY_CODEC$1, {
  size: U64_CODEC$4
});
const INSTRUCTION_DEFS$2 = {
  CreateLookupTable: {
    index: 0,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$4], ['recentSlot', U64_CODEC$4], ['bumpSeed', U8_CODEC$3]])
  },
  FreezeLookupTable: {
    index: 1,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$4]])
  },
  ExtendLookupTable: {
    index: 2,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$4], ['addresses', PUBLIC_KEY_ARRAY_CODEC]])
  },
...
const INSTRUCTION_DEFS$1 = {
  RequestUnits: {
    index: 0,
    codec: codecsDataStructures.getStructCodec([['instruction', U8_CODEC$2], ['units', U32_CODEC$3], ['additionalFee', U32_CODEC$3]])
  },
  RequestHeapFrame: {
    index: 1,
    codec: codecsDataStructures.getStructCodec([['instruction', U8_CODEC$2], ['bytes', U32_CODEC$3]])
  },
  SetComputeUnitLimit: {
    index: 2,
    codec: codecsDataStructures.getStructCodec([['instruction', U8_CODEC$2], ['units', U32_CODEC$3]])
  },
  SetComputeUnitPrice: {
    index: 3,
    codec: codecsDataStructures.getStructCodec([['instruction', U8_CODEC$2], ['microLamports', U64_CODEC$3]])
  }
};
...
const SECP256K1_INSTRUCTION_DATA_ENCODER = codecsDataStructures.getStructEncoder([['numSignatures', codecsNumbers.getU8Encoder()], ['signatureOffset', codecsNumbers.getU16Encoder()], ['signatureInstructionIndex', codecsNumbers.getU8Encoder()], ['ethAddressOffset', codecsNumbers.getU16Encoder()], ['ethAddressInstructionIndex', codecsNumbers.getU8Encoder()], ['messageDataOffset', codecsNumbers.getU16Encoder()], ['messageDataSize', codecsNumbers.getU16Encoder()], ['messageInstructionIndex', codecsNumbers.getU8Encoder()], ['ethAddress', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), ETHEREUM_ADDRESS_BYTES)], ['signature', codecsCore.fixEncoderSize(codecsDataStructures.getBytesEncoder(), SIGNATURE_BYTES)], ['recoveryId', codecsNumbers.getU8Encoder()]]);
...
const I64_NUMBER_CODEC$1 = codecsCore.transformCodec(codecsNumbers.getI64Codec(), value => BigInt(value), value => Number(value));
const PUBLIC_KEY_BYTES_CODEC$1 = codecsCore.transformCodec(codecsCore.fixCodecSize(codecsDataStructures.getBytesCodec(), 32), value => value, value => new Uint8Array(value));
const getRustStringCodec$1 = () => codecsCore.addCodecSizePrefix(codecsStrings.getUtf8Codec(), U64_CODEC$2);
const RUST_STRING_CODEC$1 = getRustStringCodec$1();
const AUTHORIZED_CODEC = codecsDataStructures.getStructCodec([['staker', PUBLIC_KEY_BYTES_CODEC$1], ['withdrawer', PUBLIC_KEY_BYTES_CODEC$1]]);
const LOCKUP_CODEC = codecsDataStructures.getStructCodec([['unixTimestamp', I64_NUMBER_CODEC$1], ['epoch', I64_NUMBER_CODEC$1], ['custodian', PUBLIC_KEY_BYTES_CODEC$1]]);
...
const STAKE_INSTRUCTIONS = ProgramInstructions.create({
  ...
  instructions: {
    Initialize: {
      index: 0,
      codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$2], ['authorized', AUTHORIZED_CODEC], ['lockup', LOCKUP_CODEC]])
    },
    Authorize: {
      index: 1,
      codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$2], ['newAuthorized', PUBLIC_KEY_BYTES_CODEC$1], ['stakeAuthorizationType', U32_CODEC$2]])
    },
    Delegate: {
      index: 2,
      codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$2]])
    },
    Split: {
      index: 3,
      codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$2], ['lamports', I64_NUMBER_CODEC$1]])
    },
    Withdraw: {
      index: 4,
      codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$2], ['lamports', I64_NUMBER_CODEC$1]])
    ...
    AuthorizeWithSeed: {
      index: 8,
      codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$2], ['newAuthorized', PUBLIC_KEY_BYTES_CODEC$1], ['stakeAuthorizationType', U32_CODEC$2], ['authoritySeed', RUST_STRING_CODEC$1], ['authorityOwner', PUBLIC_KEY_BYTES_CODEC$1]])
    }
  }
});
...
const I64_NUMBER_CODEC = codecsCore.transformCodec(codecsNumbers.getI64Codec(), value => BigInt(value), value => Number(value));
const PUBLIC_KEY_BYTES_CODEC = codecsCore.fixCodecSize(codecsDataStructures.getBytesCodec(), 32);
const getRustStringCodec = () => codecsCore.addCodecSizePrefix(codecsStrings.getUtf8Codec(), U64_CODEC$1);
const RUST_STRING_CODEC = getRustStringCodec();
const VOTE_INIT_CODEC = codecsDataStructures.getStructCodec([['nodePubkey', PUBLIC_KEY_BYTES_CODEC], ['authorizedVoter', PUBLIC_KEY_BYTES_CODEC], ['authorizedWithdrawer', PUBLIC_KEY_BYTES_CODEC], ['commission', U8_CODEC$1]]);
const VOTE_AUTHORIZE_WITH_SEED_CODEC = codecsDataStructures.getStructCodec([['voteAuthorizationType', U32_CODEC$1], ['currentAuthorityDerivedKeyOwnerPubkey', PUBLIC_KEY_BYTES_CODEC], ['currentAuthorityDerivedKeySeed', RUST_STRING_CODEC], ['newAuthorized', PUBLIC_KEY_BYTES_CODEC]]);
const INSTRUCTION_DEFS = {
  InitializeAccount: {
    index: 0,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$1], ['voteInit', VOTE_INIT_CODEC]])
  },
  Authorize: {
    index: 1,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$1], ['newAuthorized', PUBLIC_KEY_BYTES_CODEC], ['voteAuthorizationType', U32_CODEC$1]])
  },
  Withdraw: {
    index: 3,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$1], ['lamports', I64_NUMBER_CODEC]])
  },
  UpdateValidatorIdentity: {
    index: 4,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$1]])
  },
  AuthorizeWithSeed: {
    index: 10,
    codec: codecsDataStructures.getStructCodec([['instruction', U32_CODEC$1], ['voteAuthorizeWithSeedArgs', VOTE_AUTHORIZE_WITH_SEED_CODEC]])
  }
};
...
const CONFIG_KEY_DECODER = codecsDataStructures.getStructDecoder([['publicKey', codecsCore.fixDecoderSize(codecsDataStructures.getBytesDecoder(), PUBLIC_KEY_LENGTH)], ['isSigner', U8_DECODER]]);
const VALIDATOR_INFO_CONFIG_DECODER = codecsDataStructures.getStructDecoder([['configKeys', codecsDataStructures.getArrayDecoder(CONFIG_KEY_DECODER, {
  size: SHORT_U16_DECODER
})], ['infoData', codecsDataStructures.getBytesDecoder()]]);
...
const U64_NUMBER_CODEC = codecsCore.transformCodec(U64_CODEC, value => BigInt(value), value => Number(value));
const PUBLIC_KEY_CODEC = codecsCore.transformCodec(codecsCore.fixCodecSize(codecsDataStructures.getBytesCodec(), 32), value => value, value => new Uint8Array(value));
const ACCOUNT_VERSION_CODEC = codecsDataStructures.getEnumCodec(VoteStateVersion, {
  size: U32_CODEC
});
const LOCKOUT_CODEC = codecsDataStructures.getStructCodec([['slot', U64_NUMBER_CODEC], ['confirmationCount', U32_CODEC]]);
const AUTHORIZED_VOTER_CODEC = codecsDataStructures.getStructCodec([['epoch', U64_NUMBER_CODEC], ['authorizedVoter', PUBLIC_KEY_CODEC]]);
const PRIOR_VOTER_CODEC = codecsDataStructures.getStructCodec([['authorizedPubkey', PUBLIC_KEY_CODEC], ['epochOfLastAuthorizedSwitch', U64_NUMBER_CODEC], ['targetEpoch', U64_NUMBER_CODEC]]);
const PRIOR_VOTERS_CODEC = codecsDataStructures.getStructCodec([['buf', codecsDataStructures.getArrayCodec(PRIOR_VOTER_CODEC, {
  size: 32
})], ['idx', U64_NUMBER_CODEC], ['isEmpty', U8_CODEC]]);
const EPOCH_CREDITS_CODEC = codecsDataStructures.getStructCodec([['epoch', U64_NUMBER_CODEC], ['credits', U64_NUMBER_CODEC], ['prevCredits', U64_NUMBER_CODEC]]);
const BLOCK_TIMESTAMP_CODEC = codecsDataStructures.getStructCodec([['slot', U64_NUMBER_CODEC], ['timestamp', U64_NUMBER_CODEC]]);
const VOTE_ACCOUNT_V1_14_11_CODEC = codecsDataStructures.getStructCodec([['nodePubkey', PUBLIC_KEY_CODEC], ['authorizedWithdrawer', PUBLIC_KEY_CODEC], ['commission', U8_CODEC], ['votes', codecsDataStructures.getArrayCodec(LOCKOUT_CODEC, {
  size: U64_NUMBER_CODEC
})], ['rootSlotValid', U8_CODEC], ['rootSlot', U64_NUMBER_CODEC], ['authorizedVoters', codecsDataStructures.getArrayCodec(AUTHORIZED_VOTER_CODEC, {
  size: U64_NUMBER_CODEC
})], ['priorVoters', PRIOR_VOTERS_CODEC], ['epochCredits', codecsDataStructures.getArrayCodec(EPOCH_CREDITS_CODEC, {
  size: U64_NUMBER_CODEC
...
const decodeVoteAccountData = bytes => {
  try {
    ...
    if (error instanceof errors.SolanaError && error.context.__code == errors.SOLANA_ERROR__CODECS__ENUM_DISCRIMINATOR_OUT_OF_RANGE) {
