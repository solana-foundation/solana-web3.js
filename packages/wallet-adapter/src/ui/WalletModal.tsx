...
export function WalletModal({ className = '', container = 'body' }: WalletModalProps) {
    ...
    function choose(wallet: Wallet) {
        ...
        const current = () => connectionRequest.current === request && chosenName.current === name;
        void request.then(
            () => {
        ...
        createPortal(
            <dialog
                ...
                onClick={event => {
                    ...
                    if (!(event.target as Element).closest('.wallet-adapter-modal-wrapper')) setVisible(false);
                }}
                ref={ref}
            >
                <div className="wallet-adapter-modal-container">
                    <div className="wallet-adapter-modal-wrapper">
                        ...
                        {connecting && <p role="status">Connecting to {selectedWallet?.adapter.name}…</p>}
