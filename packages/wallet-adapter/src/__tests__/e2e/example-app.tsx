...
function Demo() {
    ...
    const onSignMessage = async () => {
        ...
        try {
            const signature = await signMessage(new TextEncoder().encode('hello from @solana/wallet-adapter'));
...
export function ExampleApp({ endpoint, children }: { endpoint: string; children?: ReactNode }) {
    return (
