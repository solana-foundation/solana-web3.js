...
import { deriveSignInMessageText, verifySignIn as verifyPlainSignIn } from '@solana/wallet-standard-util';
 ...
 */
export async function verifySignIn(input: SolanaSignInInput, output: SolanaSignInOutput): Promise<boolean> {
