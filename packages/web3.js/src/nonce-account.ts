import { getNonceDecoder, getNonceSize, NonceState } from '@solana-program/system';
...
export class NonceAccount {
    ...
    static fromAccountData(buffer: Uint8Array | Array<number>): NonceAccount {
        ...
        assert(nonceAccount.state === NonceState.Initialized, 'nonce account is not initialized');
        assert(
