...
export class PublicKey implements HasAddress {
     ...
     * @since 2.0.0
     */
    async verifySignature(signature: ReadonlyUint8Array, message: ReadonlyUint8Array): Promise<boolean> {
        ...
        return await verifySignatureAsync(publicKeyCryptoKey, signatureBytes(signatureSnapshot), messageSnapshot);
    }
