 ...
 */
export type PublicKeyInitData = number | bigint | string | Uint8Array | ReadonlyUint8Array | Array<number> | PublicKey;
...
export class PublicKey {
    ...
    async verifySignature(signature: Uint8Array, message: Uint8Array): Promise<boolean> {
        ...
        return await verifySignatureAsync(publicKeyCryptoKey, signatureBytes(signature), message);
    }
    ...
    static async createProgramAddress(
        ...
        const bytes = concatUint8Arrays([...seeds, programId.toBytes(), PDA_MARKER_BYTES]);
...
function isUint8ArrayLike(value: PublicKeyInitData): value is Uint8Array | ReadonlyUint8Array {
