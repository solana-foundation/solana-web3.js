...
export function coerceNumericToBigInt(value: number | bigint, valueName: string): bigint {
...
export function coerceNullableNumericToBigInt(value: number | bigint | null, valueName: string): bigint | null {
