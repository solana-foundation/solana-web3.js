 ...
 */
export const toUint8ArrayView = (arr: Uint8Array | ReadonlyUint8Array | Array<number>): Uint8Array => {
 ...
 */
export const toPackedUint8Array = (arr: Uint8Array | ReadonlyUint8Array | Array<number>): Uint8Array => {
 ...
 */
export const concatUint8Arrays = (arrays: ReadonlyArray<Uint8Array | ReadonlyUint8Array>): Uint8Array => {
