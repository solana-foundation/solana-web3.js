...
import { Message, MessageV0, MessageV1, type V1TransactionConfig, VersionedMessage } from '../message';
...
export class TransactionMessage {
    ...
    constructor(args: TransactionMessageArgs) {
        ...
        this.instructions = expandInstructionPlans(args.instructions).map(instruction =>
            isKitInstruction(instruction) ? fromKitInstruction(instruction) : instruction,
        );
    ...
    static decompile(message: VersionedMessage, args?: DecompileArgs): TransactionMessage {
        ...
        const numWritableUnsignedAccounts =
            message.staticAccountKeys.length - numRequiredSignatures - numReadonlyUnsignedAccounts;
        ...
        return new TransactionMessage({
            ...
            instructions,
            recentBlockhash,
            transactionConfig: message.version === 1 ? message.transactionConfig : undefined,
        });
    }
