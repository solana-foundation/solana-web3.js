...
const GENERATED_TO_LEGACY_INSTRUCTION_TYPE = {
    ...
    [GeneratedComputeBudgetInstruction.SetLoadedAccountsDataSizeLimit]: 'SetLoadedAccountsDataSizeLimit',
...
type ParsedInstructionOfType<TInstructionType extends GeneratedComputeBudgetInstruction> = Extract<
    ParsedAnyComputeBudgetInstruction,
    { instructionType: TInstructionType }
>;

function getInstructionType(instruction: TransactionInstruction): ComputeBudgetInstructionType {
    checkProgramId(instruction.programId);
    const generatedInstructionType = identifyComputeBudgetInstruction(instruction.data);
...
function parseComputeBudgetInstructionOfType<TInstructionType extends GeneratedComputeBudgetInstruction>(
    instruction: TransactionInstruction,
    expectedInstructionType: TInstructionType,
): ParsedInstructionOfType<TInstructionType> {
    checkProgramId(instruction.programId);
    const parsedInstruction = parseComputeBudgetInstruction(toKitInstruction(instruction));
...
export class ComputeBudgetProgram {
    ...
    static setLoadedAccountsDataSizeLimit(params: SetLoadedAccountsDataSizeLimitParams): TransactionInstruction {
        return fromKitInstruction(getSetLoadedAccountsDataSizeLimitInstruction(params));
    }
}
