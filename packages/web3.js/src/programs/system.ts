...
export type CreateAccountParams = Omit<CreateAccountFields, 'lamports' | 'space'> & {
...
export type CreateAccountWithSeedParams = Omit<CreateAccountWithSeedFields, 'lamports' | 'space'> & {
    lamports: number | bigint;
    space: number | bigint;
};
...
export type CreateNonceAccountParams = Omit<CreateNonceAccountFields, 'lamports'> & {
    lamports: number | bigint;
};
...
export type CreateNonceAccountWithSeedParams = Omit<CreateNonceAccountWithSeedFields, 'lamports'> & {
    lamports: number | bigint;
};
...
export type TransferWithSeedParams = Omit<TransferWithSeedFields, 'lamports'> & {
    lamports: number | bigint;
};
...
export type DecodedCreateAccountWithSeedInstruction = CreateAccountWithSeedFields;
...
export class SystemInstruction {
    ...
    static decodeInstructionType(instruction: TransactionInstruction): SystemInstructionType {
        ...
        return GENERATED_TO_LEGACY_INSTRUCTION_TYPE[identifySystemInstruction(instruction.data)];
    }

    /**
     * Decode a create account system instruction and retrieve the instruction params.
     */
    static decodeCreateAccount(instruction: TransactionInstruction): DecodedCreateAccountInstruction {
        this.checkProgramId(instruction.programId);
        const parsedInstruction = parseSystemInstructionOfType(instruction, GeneratedSystemInstruction.CreateAccount);

        return {
            fromPubkey: new PublicKey(parsedInstruction.accounts.payer.address),
            newAccountPubkey: new PublicKey(parsedInstruction.accounts.newAccount.address),
    ...
    static decodeTransfer(instruction: TransactionInstruction): DecodedTransferInstruction {
        this.checkProgramId(instruction.programId);
        const parsedInstruction = parseSystemInstructionOfType(instruction, GeneratedSystemInstruction.TransferSol);
     ...
     */
    static decodeAllocate(instruction: TransactionInstruction): DecodedAllocateInstruction {
        this.checkProgramId(instruction.programId);
        const parsedInstruction = parseSystemInstructionOfType(instruction, GeneratedSystemInstruction.Allocate);

        return {
            accountPubkey: new PublicKey(parsedInstruction.accounts.newAccount.address),
            space: parsedInstruction.data.space,
        };
    }
     ...
     */
    static decodeAllocateWithSeed(instruction: TransactionInstruction): DecodedAllocateWithSeedInstruction {
        this.checkProgramId(instruction.programId);
        const parsedInstruction = parseSystemInstructionOfType(
            instruction,
    ...
    static decodeAssign(instruction: TransactionInstruction): AssignParams {
        this.checkProgramId(instruction.programId);
        const parsedInstruction = parseSystemInstructionOfType(instruction, GeneratedSystemInstruction.Assign);
    ...
    static decodeAssignWithSeed(instruction: TransactionInstruction): AssignWithSeedParams {
        this.checkProgramId(instruction.programId);
        const parsedInstruction = parseSystemInstructionOfType(instruction, GeneratedSystemInstruction.AssignWithSeed);
     ...
     */
    static decodeCreateWithSeed(instruction: TransactionInstruction): DecodedCreateAccountWithSeedInstruction {
        this.checkProgramId(instruction.programId);
        const parsedInstruction = parseSystemInstructionOfType(
            instruction,
    ...
    static decodeNonceInitialize(instruction: TransactionInstruction): InitializeNonceParams {
        ...
        return {
            noncePubkey: new PublicKey(parsedInstruction.accounts.nonceAccount.address),
    ...
    static decodeNonceAdvance(instruction: TransactionInstruction): AdvanceNonceParams {
        ...
        return {
            noncePubkey: new PublicKey(parsedInstruction.accounts.nonceAccount.address),
            authorizedPubkey: new PublicKey(parsedInstruction.accounts.nonceAuthority.address),
        };
    }
     ...
     */
    static decodeNonceWithdraw(instruction: TransactionInstruction): DecodedWithdrawNonceInstruction {
        this.checkProgramId(instruction.programId);
        const parsedInstruction = parseSystemInstructionOfType(
            instruction,
        ...
        return {
            noncePubkey: new PublicKey(parsedInstruction.accounts.nonceAccount.address),
            toPubkey: new PublicKey(parsedInstruction.accounts.recipientAccount.address),
            authorizedPubkey: new PublicKey(parsedInstruction.accounts.nonceAuthority.address),
    ...
    static decodeNonceAuthorize(instruction: TransactionInstruction): AuthorizeNonceParams {
        ...
        return {
            noncePubkey: new PublicKey(parsedInstruction.accounts.nonceAccount.address),
            authorizedPubkey: new PublicKey(parsedInstruction.accounts.nonceAuthority.address),
            newAuthorizedPubkey: new PublicKey(parsedInstruction.data.newNonceAuthority),
        };
    }
 ...
 */
export type SystemInstructionType = ValueOf<typeof GENERATED_TO_LEGACY_INSTRUCTION_TYPE>;

type ParsedAnySystemInstruction = ParsedSystemInstruction<string>;

type ParsedInstructionOfType<TInstructionType extends GeneratedSystemInstruction> = Extract<
    ParsedAnySystemInstruction,
    { instructionType: TInstructionType }
>;

function parseSystemInstructionOfType<TInstructionType extends GeneratedSystemInstruction>(
