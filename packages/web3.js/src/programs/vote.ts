...
type InstructionCodecInput<TCodec> = TCodec extends Codec<infer TFrom, infer _TTo> ? TFrom : never;

type InstructionCodecOutput<TCodec> = TCodec extends Codec<infer _TFrom, infer TTo> ? TTo : never;
