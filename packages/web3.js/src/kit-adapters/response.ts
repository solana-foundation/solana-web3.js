...
function mapRpcParsedInstruction(
    instruction: RawParsedMessageInstruction | ParsedInstruction | PartiallyDecodedInstruction,
...
function mapTransactionMetaCompat(meta: TypedTransactionSource['meta']): ConfirmedTransactionMeta | null {
    ...
    return {
        ...
        ...(meta.postTokenBalances != null ? { postTokenBalances: [...meta.postTokenBalances] } : null),
        preBalances: meta.preBalances.map(balance => coerceNumericToBigInt(balance, 'preBalance')),
        ...(meta.preTokenBalances != null ? { preTokenBalances: [...meta.preTokenBalances] } : null),
