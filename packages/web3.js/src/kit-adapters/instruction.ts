...
): KitInstruction & InstructionWithAccounts<readonly AccountMeta[]> & InstructionWithData<ReadonlyUint8Array> {
...
export function fromKitInstruction(instruction: KitInstruction): TransactionInstruction {
