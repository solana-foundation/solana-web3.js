...
export function isKitInstruction(value: unknown): value is KitInstruction {
    ...
    const { accounts, data, keys, programAddress, programId } = value as Record<string, unknown>;

    if ((programAddress !== undefined || accounts !== undefined) && (programId !== undefined || keys !== undefined)) {
        throw new Error(
