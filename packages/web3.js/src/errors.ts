    ...
    constructor({
        ...
        switch (action) {
            ...
            case 'simulate':
                ...
                break;
            default: {
                message = `Unknown action '${((a: never) => String(a))(action)}'`;
            }
        }
        super(message);
...
export type SolanaJSONRPCErrorCodeEnum = (typeof SolanaJSONRPCErrorCode)[keyof typeof SolanaJSONRPCErrorCode];

export class SolanaJSONRPCError extends Error {
    code: SolanaJSONRPCErrorCodeEnum | unknown;
    data?: any;
    constructor(
        { code, message, data }: Readonly<{ code: unknown; message: string; data?: any }>,
