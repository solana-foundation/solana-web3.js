...
import { concatUint8Arrays, toPackedUint8Array, toUint8ArrayView } from '../src/utils/typed-array';
...
describe('concatUint8Arrays', () => {
    it('concatenates byte arrays in order', () => {
        const result = concatUint8Arrays([Uint8Array.from([1, 2]), Uint8Array.from([]), Uint8Array.from([3, 4])]);
