...
describe('Message', () => {
    ...
    it('compiles with Kit instructions', () => {
        ...
        expect(messageFromKitInstruction.instructions[0].data).to.eql(BASE58_DECODER.decode(new Uint8Array(1)));
    });
    ...
    it('isAccountWritable', () => {
        const accountKeys = [getUniqueAddress(), getUniqueAddress(), getUniqueAddress(), getUniqueAddress()];
