...
import { MessageAccountKeys, MessageCompiledInstruction } from '../../src/message';
...
describe('MessageAccountKeys', () => {
    it('keySegments', () => {
        ...
        const expectedSegments = [staticAccountKeys, accountKeysFromLookups.writable, accountKeysFromLookups.readonly];
    ...
    it('compileInstructions', () => {
        ...
        expect(accountKeys.compileInstructions([instruction])).to.eql([expectedInstruction]);
    });
