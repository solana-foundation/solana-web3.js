...
describe('LoaderV3Program', function () {
    it('initializeBuffer', async () => {
        ...
        expect(LoaderV3Instruction.decodeInstructionType(instruction)).to.eq('InitializeBuffer');
        expect(LoaderV3Instruction.decodeInitializeBuffer(instruction)).to.eql(params);
    });
    ...
    it('write', async () => {
        ...
        expect(LoaderV3Instruction.decodeInstructionType(instruction)).to.eq('Write');
    ...
    it('rejects write decode for the wrong program id', async () => {
        ...
        expect(() => LoaderV3Instruction.decodeWrite(wrongProgramInstruction)).to.throw(
            'invalid instruction; programId is not LoaderV3Program',
        );
    });
    ...
    it('deployWithMaxDataLen', async () => {
        ...
        expect(LoaderV3Instruction.decodeInstructionType(instruction)).to.eq('DeployWithMaxDataLen');
    ...
    it('upgrade', async () => {
        ...
        expect(LoaderV3Instruction.decodeInstructionType(instruction)).to.eq('Upgrade');
        expect(decoded).to.eql({
            ...params,
            rentSysvar: SYSVAR_RENT_PUBKEY,
            clockSysvar: SYSVAR_CLOCK_PUBKEY,
    ...
    it('setAuthority', async () => {
        ...
        expect(LoaderV3Instruction.decodeInstructionType(instruction)).to.eq('SetAuthority');
    ...
    it('setAuthorityChecked', async () => {
        ...
        expect(LoaderV3Instruction.decodeInstructionType(instruction)).to.eq('SetAuthorityChecked');
        expect(LoaderV3Instruction.decodeSetAuthorityChecked(instruction)).to.eql(params);
    });
    ...
    it('close', async () => {
        ...
        expect(LoaderV3Instruction.decodeInstructionType(instruction)).to.eq('Close');
    ...
    it('extendProgram', async () => {
        ...
        expect(LoaderV3Instruction.decodeInstructionType(instruction)).to.eq('ExtendProgram');
